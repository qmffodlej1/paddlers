...
<?
	...
	$data_insert = $pdo->prepare('INSERT INTO memo (id, name, nick, content, regist_day) VALUES (:userid, :nme, :nick, :content, :regist_day);');
	$data_insert->bindParam(':userid',$userid,PDO::PARAM_STR);
	$data_insert->bindParam(':nme',$name,PDO::PARAM_STR);
